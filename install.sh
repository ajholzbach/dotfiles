...
DOTFILES=(".vimrc" ".zshrc" ".zprofile" ".p10k.zsh" ".gitignore_global" ".condarc" ".config/zed" ".config/bat" ".config/btop" ".config/thefuck" ".config/lazygit" ".config/ghostty" ".config/fish" ".config/starship.toml")
